...
const WhatsAppButton = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Find the first section (usually the hero) to get its exact height
      const heroSection = document.querySelector('main > section');
      const scrollThreshold = heroSection ? heroSection.clientHeight * 0.8 : window.innerHeight * 0.8;
      
      // Show the button when scrolled past the hero section
